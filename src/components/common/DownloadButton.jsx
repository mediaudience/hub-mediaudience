...
// contra el morado/magenta de fondo. "solid" usa el mismo degradado
// morado-a-magenta del banner de GradientHeader, con letra blanca -- para
// cuando el botón vive sobre fondo blanco (junto a Tabs en
  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-full border whitespace-nowrap ${
        onDownload
          ? esSolido
            ? "bg-gradient-to-r from-brand-purple to-brand-magenta text-white border-transparent hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-purple"
          ...
          : esSolido
          ? "bg-gradient-to-r from-brand-purple to-brand-magenta text-white/70 border-transparent opacity-40 cursor-not-allowed"
